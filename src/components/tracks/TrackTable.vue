  ...
  <div class="track-table">
    ...
    <div
      ...
      <div class="table-cell column-number">
        <i v-if="shouldShowPlay(index)" class="fas fa-play fa-sm"></i>
      ...
      <div class="table-cell column-album">{{ track.album.name }}</div>
...
export default {
  ...
  methods: {
    shouldShowPlay(index) {
        return this.hoveredTrack === index || this.activatedTrack === index;
    },
    ...
    getTrackClass(index) {
      return {
        active: this.activatedTrack === index
      }
    },

    onTrackClick(index) {
      this.activatedTrack = index;
    },
